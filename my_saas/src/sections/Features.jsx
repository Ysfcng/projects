...
<ul className="relative flex justify-around flex-grow px-[5%] border-2  border-s3 relative
...
<li key={id} className="relative pt-16 px-4 pb-14">
    ...
    <div className="flex items-center justify-center mx-auto  mb-3 border-2 border-s3 rounded-full hover:border-s4 transtition-all duration-500
    shadow-500 size-20">
        <img className="size-17/20 object-contain z-20" src={icon} alt={title} />
    </div>
