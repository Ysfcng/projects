...
<Element className="hero">
    <div className="container">
        <div className="relative z-2 max-w-512 max-lg:max-w-388">
            ...
            <p className="max-w-440 mb-14 body-1 max-md:mb-10">We design xora video editor to be easy to use, quick to and suprisingly powerful </p>
...
<Button icon="/images/zap.svg">Try it now</Button>
        ...
        <div className=" absolute -top-32 left-[calc(50%-340px)] w-[1230px] pointer-events-none her0-img_res">
